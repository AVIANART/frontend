<script setup lang="ts">
    ...
    const props = defineProps({
        ...
        options: {
            ...
            required: false,
            default: () => [{ value: -1, label: 'Select an available option' }],
        },
        value: {
            type: String,
            required: false,
...
<template>
    <div class="form-group d-inline-block w-100">
        <div class="input-group mb-3 w-100">
            <span :id="name" class="input-group-text pe-10">{{ name }}</span>
            ...
            <span :id="name+'help'" class="input-group-text"><a href="#" data-bs-toggle="popover" data-bs-html="true" :data-bs-content="help.length > 0 ? help : name">?</a></span>
        </div>
    </div>
</template>